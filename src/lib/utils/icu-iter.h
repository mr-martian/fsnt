 ...
 * https://github.com/apertium/lexd/blob/master/src/icu-iter.h
 */
#ifndef _ICU_ITER_H_
#define _ICU_ITER_H_
...
int stoi(const icu::UnicodeString& str);
unsigned long stoul(const icu::UnicodeString& str);
double stod(const icu::UnicodeString& str);
